  ...
  return (
    <main>
      ...
      <div className="mx-auto max-w-2xl px-5 py-10">
        ...
        {searchParams.e && <p className="mb-4 rounded-lg bg-red-50 px-3 py-2 text-sm text-red-600">お名前・団体名は必須です。</p>}
        <form action={inquiryAction} className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div><label className={lb}>ご連絡先（メール/電話）</label><input name="contact" className={inp} /></div>
          </div>
