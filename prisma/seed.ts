  ...
  const realInterviews: any[] = [
    {
      ...
      mainImage: "/images/interviews/yano-portrait.jpg",
      bodyAbout:
...
<figure><img src="/images/interviews/yano-oita-bussan.jpg" alt="大分の温泉・特産品をPRする矢野さん" /><figcaption>大分の温泉・特産品をPRする矢野さん（おおいた温泉座）。地方の魅力を、東京へ。</figcaption></figure>
