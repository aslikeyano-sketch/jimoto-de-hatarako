...
<div class="photo-row"><figure><img src="/images/interviews/yano-futari.jpg" alt="人と人をつなぐ矢野さん" /><figcaption>「誰とやるか」を大切に。</figcaption></figure><figure><img src="/images/interviews/yano-community.webp" alt="世代を越えて人が集まる場" /><figcaption>世代を越えて集まる場を。</figcaption></figure></div>`,
      bodyChallenge:
...
<div class="photo-row"><figure><img src="/images/interviews/yano-farm-team.jpg" alt="地域で農作業に取り組むメンバー" /><figcaption>地域に入り、汗をかく。</figcaption></figure><figure><img src="/images/interviews/yano-farm-veg.jpg" alt="地域の農産物を手にする矢野さん" /><figcaption>地方の恵みを、全国へ。</figcaption></figure></div>`,
      bodyLocalLove:
...
東京に出たからこそ、地元に返せるものがある。そう思える人が一人でも増えたら、うれしいです。`,
    ...
    {
      slug: "miyazaki-honda-epicventure",
      status: "published",
      prefecture: "miyazaki",
      city: "宮崎市",
      companyName: "株式会社EpicVenture",
      companySlug: "",
      personName: "本田 いちご",
      personRole: "代表",
      category: "東京から地元に関わる人",
      tags: "宮崎県,経営者,地方創生,Uターン,販路拡大,PR,コミュニティ,東京から関わる",
      title: "「東京に出たからこそ、地元のためにできることがある」",
      subtitle: "東京と地方の間に、新しい仕事と人の流れをつくる。株式会社EpicVenture 代表・本田いちごさん。",
      mainImage: "/images/interviews/honda-ichigo.webp",
      bodyAbout:
`現在は東京を拠点に、株式会社EpicVentureの代表として、地方と東京をつなぐ事業に取り組む本田いちごさん。同郷の若者や経営者が集まる県人会コミュニティづくりから、地方企業の販路開拓、WEB・PR支援と、その活動領域は幅広い。その中心にある考えは一つ。**「東京にある人・企業・情報を、地方の可能性につなげること」**です。

EpicVentureが目指しているのは、単なる制作会社やコンサルティング会社ではありません。地方企業が抱える課題は、一社一社異なります。ある会社は、良い商品があるのに東京での販路がない。ある会社は、人を採用したくても若い世代に会社を知られていない。またある会社では、日々の業務に追われ、WEBやSNSまで手が回っていない。

「最初から『HPを作りましょう』『SNSを活用しましょう』ではないと思っています。まず、その会社が何に困っていて、何を実現したいのかを知りたいんです」

必要なのがHPなら、HPをつくる。採用なら、採用の発信を考える。東京での販路なら、イベントの企画やバイヤー・商社との接点を創出する。サービスを売ることではなく、**「その企業が次に進むためには何が必要なのか」**から考える——それが本田さんのスタンスです。`,
      bodyStart:
`本田さんは宮崎県宮崎市で生まれ育ち、その後、東京へ。最初から地方創生を仕事にしようと考えていたわけではなかったといいます。転機になったのは、東京でさまざまな経営者や企業と出会う中で経験した、同郷の人たちとのつながりでした。

「『宮崎出身です』と言っただけで急に距離が縮まることが何度もあったんです。年齢も仕事も全然違うのに、地元が同じというだけでつながれる。それってすごいことだと思いました」

一方、宮崎へ目を向けると、別の景色が見えてきました。良い商品をつくっている。高い技術を持っている。地域に根付き、長く事業を続けている。それでも東京では、ほとんど知られていない企業が数多くあった。

「東京には人も企業も情報も集まっています。でも地方には、まだ東京に届いていない魅力がたくさんある。その間をつなげたら、もっと面白いことができるんじゃないかと思ったんです」`,
      bodyStrength:
`EpicVentureの特徴の一つが、東京にいる同郷者とのネットワークです。本田さんは、県出身者が集まる県人会や、若い世代のコミュニティづくりにも取り組んでいます。そのネットワークは、交流だけを目的としたものではありません。地方企業にとって、新しい可能性にもなり得ます。

「東京に出てきた若い人の中にも、『いつか地元に戻りたい』『地元に関わる仕事がしたい』と思っている人はいます。でも、地元にどんな面白い会社があるのか知らないんですよね」

地方企業の経営者や働く人の姿を東京へ届ける。それによって、Uターン採用や副業、仕事での協業など、新しい接点を生み出す。採用だけではありません。東京で活躍する地元出身の経営者が、地元企業の取引先になることもある。東京にいる人が、地元の商品を買うこともできる。本田さんは、こうした関係を増やしていきたいといいます。`,
      bodyWhyLocal:
`本田さんが大切にしている考えがあります。それは、**「地方を応援するために、必ずしも地方へ戻る必要はない」**ということ。

「私自身も宮崎を出て、東京で仕事をしています。でも、東京に出たからこそ宮崎の良さに気づいた部分もたくさんあります」

東京に住みながら、地元の商品を買う。地元企業と仕事をする。東京の企業を地元企業に紹介する。地元にゆかりのあるイベントを企画する。SNSで地元の魅力を発信する。関わり方は一つではありません。

「東京に出たから地元との関係が終わるのではなくて、外に出たからこそできることもあると思っています」`,
      bodyChallenge:
`良い会社なのに、知られていない。良い商品なのに、届け方が分からない。採用したいのに、若い人に会社の存在が届いていない。本田さん自身、地方企業と接する中で、そんな場面を何度も見てきました。

だからこそ今回新たに始めるのが、地方企業の経営者にスポットを当てるインタビューメディアです。単に会社を紹介するだけではなく、経営者が何を考え、どんな未来を目指し、今どんな人との出会いを求めているのかまで伝える。そして、記事を読んで終わりではなく、その先に人や企業との出会いをつくる。このメディアそのものも、本田さんが目指す「東京だからできる地方創生」の一つです。`,
      bodyFuture:
`いま本田さんたちが挑戦しているのは、こうした仕組みを宮崎だけで終わらせないことです。目指すのは全国。

それぞれの地域に人のネットワークがあり、そこに地方企業、東京企業、若者、経営者、自治体などが参加する。そして「東京に販路をつくりたい」「地元の人材を採用したい」「もっと全国に商品を届けたい」「地方企業と一緒に事業をしたい」——そんなときに人と人がつながり、実際の仕事が生まれていく。

「最終的には、地方と東京をつなぐプラットフォームをつくりたいです。相談が来たら、必要な人や企業につながって、そこから新しい仕事が生まれる。そんな状態を全国につくりたいと思っています」`,
      bodyConnect:
`「地方側では、『良いものは持っているけれど、次にどう広げればいいか分からない』という企業の方とお会いしたいです。最初から相談内容が決まっていなくても大丈夫です。

東京側では、地方企業と一緒に何かやってみたい企業や経営者、バイヤー、商社、クリエイター、若い方々とつながりたいと思っています。

地方と東京の間に、新しい仕事や挑戦を一つでも多くつくっていきたいです」`,
      bodyMessage:
`東京に出た人と、地元に残る人。地方企業と、東京企業。地域の商品と、それをまだ知らない消費者。離れているもの同士をつなぐことで、新しい可能性が生まれる。

本田さんたちの挑戦は、まだ始まったばかりだ。`,
      compRepresentative: "代表　本田 いちご",
      compAddress: "東京都（宮崎県宮崎市出身）",
      compBusiness: "地方と東京をつなぐ事業／県人会・コミュニティづくり／地方企業の販路開拓／WEB・PR支援",
      compFounded: "",
      compUrl: "",
      compSns: "",
      compRecruit: "",
      ...
      recommend: true,
      featured: false,
      seoTitle: "「東京に出たからこそ、地元のためにできることがある」株式会社EpicVenture 本田いちご｜地元で働こう",
      seoDescription: "東京と地方の間に、新しい仕事と人の流れをつくる。宮崎出身・株式会社EpicVenture代表 本田いちごさんに聞く、東京だからできる地方創生。",
      publishedAt: now,
    },
  ];
